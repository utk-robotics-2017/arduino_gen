...
class VpidList(ComponentList):
    ...
    def add(self, json_item, device_dict, device_type):
        ...
        vpid = VPID(json_item['label'], json_item['kp'], json_item['ki'], json_item['kd'],
                    min_output, max_output, json_item['reverse'])
        self.vpid_list.append(vpid)

        return vpid

    def get_includes(self):
        return '#include "vPID.h"\n'
    ...
    def get_command_functions(self):
        ...
        rv += "\t\treturn;\n"
        rv += "\t}\n"
        rv += "\tvpids[indexNum].SetMode(MANUAL);\n"
