...
class PidList(ComponentList):
    ...
    def get_command_functions(self):
        ...
        if len(self.pidList) > 0:
            ...
            rv += "\tcmdMessenger.sendBinArg(pids[indexNum].GetKp());\n"
            rv += "\tcmdMessenger.sendBinArg(pids[indexNum].GetKi());\n"
            rv += "\tcmdMessenger.sendBinArg(pids[indexNum].GetKd());\n"
        ...
        if len(self.vpidList) > 0:
            ...
            rv += "\tcmdMessenger.sendBinArg(vpids[indexNum].GetKp());\n"
            rv += "\tcmdMessenger.sendBinArg(vpids[indexNum].GetKi());\n"
            rv += "\tcmdMessenger.sendBinArg(vpids[indexNum].GetKd());\n"
            rv += "\tcmdMessenger.sendCmdEnd();\n"
            rv += "}\n\n"
