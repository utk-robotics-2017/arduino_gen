...
// Constructors
const char digital_index = 0;
QTRSensorsRC digital_linsensor_arrays[1] = {
    QTRSensorsRC((unsigned char[]){1, 2, 3, 4, 5}, 5)
};
const char analog_index = 0;
QTRSensorsAnalog analog_linsensor_arrays[1] = {
    QTRSensorsAnalog((unsigned char[]){1, 2, 3, 4, 5}, 5)
};
