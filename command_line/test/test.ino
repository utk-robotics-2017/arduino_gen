...
switches[course_switch_index] = course_switch_pin;
switches[lift_switch_index] = lift_switch_pin;
switches[a_button_index] = a_button_pin;
...
encoders[right_front_wheel_encoder_index] = new Encoder(right_front_wheel_encoder_pinA, right_front_wheel_encoder_pinB);
...
void setup() {
    // Init LED pin
    pinMode(LED, OUTPUT);    pinMode(%s_pin, INPUT_PULLUP);
    pinMode(%s_pin, INPUT);
